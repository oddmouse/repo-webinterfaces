...
A short guide on forking and creating a pull request can be found here: [contributing] (https://github.com/xbmc/repo-webinterfaces/blob/master/CONTRIBUTING.md).
...
This branch is used for add-ons that are designed for Kodi v22 Piers builds and higher only. From these code repositories and branches our back-end uploads .zip files of the compatible add-ons to our main mirror server.
...
* [Add-on rules](https://github.com/xbmc/repo-webinterfaces/blob/master/CONTRIBUTING.md)
